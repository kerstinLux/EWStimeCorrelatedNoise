...
%         W =cumsum([zeros(M,1) dW],2);
    ...
    case 'fBM'
        ...
        H=0.9;
        covMatrixTask = ['Starting the calculation of the covariance matrix. This might take approximately 15 minutes depending on your machine.'];
        disp(covMatrixTask);
...
%         W =cumsum([zeros(M,1) dW],2);
        ...
        for i=1:M
            sample = ['Sample number drawn is:',num2str(i)];
            disp(sample);
